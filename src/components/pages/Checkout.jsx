...
const Checkout = () => {
    ...
    useEffect(() => {
        if (cartItems.length === 0 && !orderComplete) navigate("/cart");
            ...
            <div className="flex-1 py-16 flex flex-col justify-center items-center bg-gradient-to-r from-furniture-cream to-furniture-warm">
                <div className="bg-white p-10 rounded-lg shadow-lg max-w-xl text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                        Thank you for your purchase. A confirmation email has
                        been sent to {shippingInfo.email || "your email"}.
                    </p>
                    <div className="flex flex-col sm:flex-row justify-center gap-4">
                        <Link
                            to="/"
                            className="bg-furniture-green text-white font-bold py-3 px-6 rounded-lg transition-colors duration-300"
                        >
                            Back to Home
                        </Link>
                        <Link
                            to="/shop"
                            className="border-2 border-furniture-green text-furniture-green hover:bg-gray-50 font-bold py-3 px-6 rounded-lg transition-colors duration-300"
                        >
                            Continue Shopping
                        </Link>
                    </div>
                        ...
                        <div className="p-6 md:p-8">
                            {step === 1 ? (
                                ...
                                >
                                    ...
                                    <button
                                        type="submit"
                                        className="w-full bg-furniture-green text-white font-bold py-3 px-6 rounded-lg"
                                    >
                                        Continue to Payment
                                    </button>
                                </form>
