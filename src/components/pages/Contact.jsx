  ...
  const contactInfo = [
      {
          ...
          details: ["123 Furniture Street, Dekerns, Dakahliya Governorate"],
      },
      {
          icon: <PhoneIcon className="text-furniture-green w-8 h-8" />,
          title: "Call Us",
          details: ["+201099613458"],
      },
      {
          icon: <EmailIcon className="text-furniture-green w-8 h-8" />,
          title: "Email Us",
          details: ["modern-furniture@gmail.com"],
      },
      {
              ...
              <div className="w-full mx-auto my-14 py-14 bg-[rgb(242,240,237)]">
                  <div className=" container mx-auto px-4">
                      <div className="text-center mb-12">
                          ...
                          <p className="text-gray-600">
                              Located in the heart of Dekerns, our
                      ...
                      <div className=" w-full rounded-lg   text-center">
                          ...
                          <p className="text-gray-600 mb-4">
                              123 Furniture Street, Dekerns, Dakahliya
                              Governorate
                          </p>
                          <a
                              href="https://maps.app.goo.gl/zyGDavJhm5pcYSsM9"
                              target="_blank"
